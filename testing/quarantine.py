...
# Intengrity Check: the rows in the quarantine_dict must match the files in the test_data.quarantine
# dir.
...
if (institution, requirement_id) in quarantined_dict.keys():
...
can_ellucian = 'No' if can_ellucian.lower().startswith('n') else 'Yes'
